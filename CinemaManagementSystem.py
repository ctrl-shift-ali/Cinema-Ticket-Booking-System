...
movieOptions = [
    ...
    },
    {
        ...
        "roomNumber": 2,
        "slots": [
            {"showTime": "15:30", "price": 1400},
            {"showTime": "18:30", "price": 1700},
            {"showTime": "21:30", "price": 1900},
            {"showTime": "00:30", "price": 2100},
        ],
    },
    {
        "title": "Golden Hour",
    ...
    },
    {
        ...
        "roomNumber": 5,
        "slots": [
            {"showTime": "10:00", "price": 1100},
            {"showTime": "13:00", "price": 1300},
...
def getPermanentBookedSeats(roomNumber):
    ...
    alreadyBookedSeats = rnd.randint(3,15)
